...
<div class="frontpage">
	...
	$projects = getAllProjects($current_user->ID);
	if(!empty($projects)) { ?>
		...
		<div style="width:100%;float:left;">
			<?php foreach($projects as $project) { ?>
				...
				<div style="width:19%;float:left;">					
					<div class="project_title"><a href="<?php echo site_url(); ?>/project?project_id=<?php echo $project['project_id']; ?>"><?php echo $project['name']; ?></a></div>
					<div class="project_image_box">
					<a href="<?php echo site_url(); ?>/project?project_id=<?php echo $project['project_id']; ?>"><img src="<?php echo get_template_directory_uri(); ?>/user_image/<?php echo $project['image']; ?>" height="110" /></a></div>
